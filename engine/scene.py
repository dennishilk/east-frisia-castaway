...
class IdleCharacter:
    ...
    def draw(self, surface: pygame.Surface) -> None:
        ...
        rect = pygame.Rect(self.base_x + offset, self.base_y, self.width, self.height)
        pygame.draw.rect(surface, CHARACTER_COLOR, rect)
...
class Scene:
    ...
    def render(self, surface: pygame.Surface) -> None:
        ...
        water_rect = pygame.Rect(0, self.height // 2 + 36, self.width, self.height // 2)
        pygame.draw.rect(surface, WATER_COLOR, water_rect)

        islet_rect = pygame.Rect(self.width // 2 - 26, self.height // 2 + 18, 52, 24)
        pygame.draw.rect(surface, ISLET_COLOR, islet_rect)
